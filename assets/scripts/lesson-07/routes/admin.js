...
router.get('/products/edit/:id', admin_controller.getEditProduct);

router.put('/products/update/:id', admin_controller.updateProduct);

router.delete('/products/delete/:id', admin_controller.deleteProduct);
